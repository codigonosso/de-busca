...
module.exports = function (redis, query, configuration, callback) {
  ...
  queryWords.forEach(function (queryWord) {
    ...
    var indexes = bitap(configuration.vocabulary, queryWord, configuration.errors)
  ...
  persistence.retrieve.wordOnlyIndexes(redis, matches, callback)
